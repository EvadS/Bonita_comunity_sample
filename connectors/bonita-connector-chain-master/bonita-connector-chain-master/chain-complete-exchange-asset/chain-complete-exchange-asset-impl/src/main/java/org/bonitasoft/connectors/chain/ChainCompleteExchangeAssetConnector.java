 ...
 */
public class ChainCompleteExchangeAssetConnector extends AbstractChainCompleteExchangeAssetImpl {
    ...
    protected void executeBusinessLogic() throws ConnectorException {
        ...
        final Logger logger = LoggerFactory.getLogger(ChainCompleteExchangeAssetConnector.class);
        ...
        try {
            ...
            // Build transaction using the baseTransaction
            Transaction.Template completeTransaction = new Transaction.Builder()
                    .setBaseTransaction(getBaseTransaction())
                    .addAction(inputTransaction)
                    .addAction(outputTransaction).build(client);

            // Sign the transaction
            Transaction.Template signedIssuance = HsmSigner.sign(completeTransaction);
